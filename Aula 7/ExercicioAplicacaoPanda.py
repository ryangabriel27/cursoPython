...
with open("Aula 7/dados_funcionarios.yaml", "r") as file:
...
print("Funcionários com salário acima de 4000:")
...
print("==================================")
print("Folha de pagamente dos funcionarios antes do ajuste:")
folha_de_pagamento = df['salario'].sum()
print(folha_de_pagamento)
print("==================================")
print("Folha de pagamente dos funcionarios depois do ajuste:")
folha_de_pagamento = df['salario_ajustado'].sum()
print(folha_de_pagamento)
print("==================================")

# cria um Arquivo CSV com o dataFrame
# df.to_csv('Aula 7/dados_funcionarios.csv', index=False)
